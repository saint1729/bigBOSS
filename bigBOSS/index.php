...
<title>bigBOSS - BOSS of all Search Engines</title>
</head>


<body class="yui-skin-sam" id="yahoo-com">
<div align='center'><img class='logo' src='bigBOSS.gif' /></div>
<form action='bigBOSS.php' method='POST'>
<div align='center'><input id='inputvalue' class='textfield' type='text' name='input'/></div>
<div align='center' class="hidden"><input class='submit' type='submit' name='submit' value='Go on' /></div>

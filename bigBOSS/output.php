...
echo 	"<head>
	...
	<tr>
	<td><a href='index.php'><img class='logo_small' src='gobot_small.jpg' /></a></td>
...
list($width, $height, $type, $attr) = getimagesize("gobot_small.jpg");
...
<p class='footer'>This WebApp is designed by <b>Sai Nikhil Thirandas</b>. &copy;2012 <a href="javascript:void(0)">tsndiffopera</a> <b>|</b> <a href="javascript:void(0)" onclick="window.open('http://products.wolframalpha.com/api/termsofuse.html')">Terms of Use</a></p>
